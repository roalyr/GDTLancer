...
- ATOMIC_TASKS:
  ...
  - [x] TASK_1: Per-sector economy inertia thresholds
  ...
  - [x] TASK_2: Conditional world-age economy modifiers
    - File: `grid_layer.py`
  ...
  - [x] TASK_3: Colony maintenance economy drain
    - File: `grid_layer.py`
  ...
  - [x] TASK_4: Population density economy pressure
    - File: `grid_layer.py`
  ...
  - [x] TASK_5: Economy-gated mortal spawn
  ...
  - [x] TASK_6: Mortal survivor penalty and disruption attrition
    - Files: `constants.py`, `agent_layer.py`
  ...
  - [x] TASK_7: Update tests for economy diversity and population mechanics
  ...
  - [x] VERIFICATION_1: 90-tick run (seed 123) — economy shows ≥2 levels at t30, t60, t90 (not all RICH)
  - [x] VERIFICATION_2: 300-tick run (seed 123) — during DISRUPTION, economy is mixed (not blanket POOR); during RECOVERY, not blanket RICH
  - [x] VERIFICATION_3: 300-tick run (seed 123) — population count at t300 ≤ 25 (currently 26; target: plateau near 20)
  - [x] VERIFICATION_4: 300-tick run (seed 123) — wealth distribution at any snapshot: no tier > 60% of agents
  - [x] VERIFICATION_5: 90-tick run — colony maintenance visible: hub sectors without active trade degrade economy
  - [x] VERIFICATION_6: `python3 -m unittest tests.test_affinity -v` — all tests pass
