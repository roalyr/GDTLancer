...
--- Start of ./scenes/levels/sectors/sector_system_elace/star_elace_sprite.tscn ---

[gd_scene load_steps=5 format=2]

[ext_resource path="res://assets/models/sprites/Star_sprite_square_wide.glb" type="PackedScene" id=1]
[ext_resource path="res://assets/art/shaders/star_sprite.gdshader" type="Shader" id=2]

[sub_resource type="ShaderMaterial" id=1]
shader = ExtResource( 2 )
shader_param/albedo = Color( 0.733333, 0.388235, 0.215686, 1 )
shader_param/scale_near = 10.0
shader_param/scale_peak = 6.0
shader_param/scale_far = 0.2
shader_param/peak_distance = 5000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 10000.0
...
shader_param/scale_near = 7.0
shader_param/scale_peak = 3.0
...
[node name="Star Elace Sprite" type="Spatial"]

[node name="Star_sprite_square_wide" parent="." instance=ExtResource( 1 )]

[node name="Plane" parent="Star_sprite_square_wide" index="0"]
material_override = SubResource( 1 )

[node name="Star_sprite_square_wide_core" parent="." instance=ExtResource( 1 )]

[node name="Plane" parent="Star_sprite_square_wide_core" index="0"]
material_override = SubResource( 2 )

[editable path="Star_sprite_square_wide"]
[editable path="Star_sprite_square_wide_core"]
...
[ext_resource path="res://assets/art/materials/scene_materials/star_1_surface.tres" type="Material" id=1]
[ext_resource path="res://scenes/levels/sectors/sector_system_elace/star_elace_sprite.tscn" type="PackedScene" id=2]
[ext_resource path="res://assets/art/materials/scene_materials/star_1_corona.tres" type="Material" id=3]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=4]
...
[node name="Star Elace Sprite" parent="ModelAdditional" instance=ExtResource( 2 )]
...
[ext_resource path="res://scenes/levels/sectors/sector_system_elace/star_elace_sprite.tscn" type="PackedScene" id=8]
...
shader = ExtResource( 9 )
shader_param/albedo = Color( 0.294118, 0.0313726, 0.278431, 1 )
shader_param/scale_near = 0.2
shader_param/scale_peak = 0.77
shader_param/scale_far = 0.35
shader_param/peak_distance = 40000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.3
