...
- **Moving Time Forward:** The clock ticks when the player takes a major action (like completing a mission) or travels between stations. Talking to people or writing logs does not advance the clock.
...
- When a player rolls poorly (a Setback or Crisis), the penalty forces a direct hit to a community resource or ship condition.
...
- The health of a sector, shown as 0-10 numbers (Wealth, Security, Morale, Supplies) and simple tags like "POOR" or "HARSH".
...
3. **Flight Mode Dangers:**
   - When the player is actually flying the ship (Flight Mode), how do tags like "HARSH" or "POOR" change the number of asteroids or enemies that spawn?
