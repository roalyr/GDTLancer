...
const MainHUDScene = preload("res://core/ui/main_hud/main_hud.tscn")
const ContractSystemScript = preload("res://core/systems/contract_system.gd")
const TradingSystemScript = preload("res://core/systems/trading_system.gd")
const InventorySystemScript = preload("res://core/systems/inventory_system.gd")
const CharacterSystemScript = preload("res://core/systems/character_system.gd")
const AssetSystemScript = preload("res://core/systems/asset_system.gd")
