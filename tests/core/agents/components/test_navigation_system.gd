...
func test_initial_state_is_idle():
	...
	assert_eq(nav_system._current_command.type, nav_system.CommandType.IDLE, "Default command should be IDLE.")
...
func test_stop_command_emits_reached_destination_signal():
	...
	assert_eq(captured_args[0], agent_body, "The first argument of the signal should be the agent_body.")
